...
if (!highTexContent.includes('x: -95;') || !highTexContent.includes('x: -75;')) {
  console.error('  [Offset Warning] dash_trail (-95) or laser_trail (-75) offset missing in textureMap_high.scss!');
  hasErrors = true;
} else {
  console.log('  ✓ Dash trail (-95) and laser trail (-75) offsets calibrated');
}
