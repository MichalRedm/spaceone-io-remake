...
- **Styling**: Modular SCSS (7-1 directory pattern: `abstracts/`, `base/`, `components/`, `layout/`, `views/`) adhering to strict BEM naming methodology and design system tokens specified in [`.agents/rules/design_standards.md`](./design_standards.md).
