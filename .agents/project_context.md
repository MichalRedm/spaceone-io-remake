...
- **Frontend Stack**: JavaScript / TypeScript, Pixi.js (`pixi.js`, `pixi-layers`, `pixi-particles`), WebGL Canvas, HTML5 WebSockets, SCSS, Parcel/Webpack bundler.
...
- [ ] Upgrade/modernize client build toolchains and web UI.
