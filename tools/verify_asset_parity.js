...
if (!highTexContent.includes('x: -80;')) {
  console.error('  [Offset Warning] dash_trail or laser_trail offset -80 missing in textureMap_high.scss!');
  hasErrors = true;
} else {
  console.log('  ✓ Dash trail and laser trail offsets (-80) calibrated');
}
