...
if (!highTexContent.includes('x: -75;')) {
  console.error('  [Offset Warning] dash_trail or laser_trail offset -75 missing in textureMap_high.scss!');
  hasErrors = true;
} else {
  console.log('  ✓ Dash trail and laser trail offsets (-75) calibrated');
}
